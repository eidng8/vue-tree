...
/**
 * A very basic Nightwatch custom command. The command name is the filename and
 * the exported "command" function is the command.
 *
 * Example usage:
...
exports.command = function command(data) {
  ...
  this.execute(
    ...
    // The arguments for the function to be sent to the browser are specified
    // in this array
    [data],

    function(result) {
      // The "result" object contains the result of what we have sent back from
      // the browser window
